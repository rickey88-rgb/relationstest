    ...
    <>
      ...
      {isFinished && !unlocked && !analyzing && (
        ...
        >
          ...
          <p style={{ marginTop: 14, lineHeight: 1.7 }}>Testet undersöker omsorg, egna behov och gränser. {teaserDistinct ? "Ett område framträder tydligare än de andra och påverkar hur helheten bör tolkas." : "Flera områden ligger nära varandra. Hur de samspelar är viktigt för att förstå helheten."}</p>
