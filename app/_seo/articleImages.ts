...
export const articleImagePlans: readonly ArticleImagePlan[] = [
  ...
  { route: "/love-bombing-relation", priority: 4, concept: "Ett vertikalt femstegsflöde från intensiv uppmärksamhet och snabb närhet via stark anknytning till förändrat beteende och ett upprepat mönster.", heading: "Love bombing – hur mönstret kan utvecklas", alt: "Vertikalt femstegsdiagram över hur love bombing kan utvecklas från intensiv uppmärksamhet och snabb närhet till stark anknytning, förändrat beteende och upprepning", fileName: "love-bombing-hur-monstret-kan-utvecklas.webp", placement: "Efter definitionen och före de tio tecknen.", aspectRatio: "4:5", useAsOpenGraph: true, width: 1200, height: 1500, sourcePath: "/seo-images/love-bombing-hur-monstret-kan-utvecklas.webp", ogImage: { heading: "Love bombing – hur mönstret kan utvecklas", brief: "Förenklad OG-version med intensiv uppmärksamhet, snabb närhet och stark anknytning.", fileName: "love-bombing-hur-monstret-kan-utvecklas-og.webp", width: 1200, height: 630, sourcePath: "/seo-images/love-bombing-hur-monstret-kan-utvecklas-og.webp" } },
  { route: "/traumabindning-i-relation", priority: 5, concept: "En vertikal femstegssekvens: spänning, konflikt, försoning, lättnad och ny spänning.", heading: "Traumabindning – hur cykeln kan se ut", alt: "Vertikalt femstegsdiagram över en traumabindningscykel med spänning, konflikt, försoning, lättnad och ny spänning", fileName: "traumabindning-hur-cykeln-kan-se-ut.webp", placement: "Efter förklaringen av begreppet och före avsnittet om hur traumabindning kan kännas.", aspectRatio: "4:5", useAsOpenGraph: true, width: 1200, height: 1500, sourcePath: "/seo-images/traumabindning-hur-cykeln-kan-se-ut.webp", ogImage: { heading: "Traumabindning – hur cykeln kan se ut", brief: "Förenklad OG-version med konflikt, försoning och ny spänning.", fileName: "traumabindning-hur-cykeln-kan-se-ut-og.webp", width: 1200, height: 630, sourcePath: "/seo-images/traumabindning-hur-cykeln-kan-se-ut-og.webp" } },
