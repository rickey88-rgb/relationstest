...
export default function AutismSelfTestPage() {
  ...
  const preview = result && result.leadingGap >= 15
    ? { title: "Ett mönster i dina svar sticker ut", body: "Ett av områdena i testet framträder tydligare än de andra och påverkar hur din samlade profil bör tolkas.", next: "Vilket område det gäller visas i din fullständiga analys." }
