    ...
    <main className="mx-auto max-w-3xl px-4 py-10 text-neutral-900 sm:px-6 sm:py-14">
      <article>
        ...
        <section className="mt-10 space-y-4 leading-7 text-neutral-700">
          ...
          <p>Om oron leder till återkommande förhör, telefonkontroll eller regler för vem du får träffa finns en separat guide om <Link href="/svartsjuk-partner" className="underline underline-offset-4">svartsjuka som blir kontroll i relationen</Link>.</p>
        ...
        <section className="mt-10 space-y-4 leading-7 text-neutral-700">
          ...
          <p>Om du återkommande tar över partnerns problem och låter egna behov vänta kan du också läsa om <Link href="/medberoende" className="underline underline-offset-4">medberoende och överansvar</Link>. Det perspektivet handlar om hur ansvar och utrymme fördelas, snarare än enbart om närhet och oro.</p>
