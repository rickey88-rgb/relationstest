    ...
    <EditorialSurface><main data-rv="container" className="mx-auto max-w-3xl px-4 py-10 text-neutral-900 sm:px-6 sm:py-14">
      <article>
        ...
        <section className="mt-10 space-y-4 leading-7 text-neutral-700">
          ...
          <p>Det finns en viktig skillnad mot <Link href="/silent-treatment-relation" className="underline underline-offset-4">silent treatment</Link>, där tystnad används bestraffande eller får en sådan funktion i ett återkommande mönster. Guiden om <Link href="/stonewalling-relation" className="underline underline-offset-4">stonewalling och känslomässig nedstängning</Link> förklarar också hur stark stress skiljer sig från en paus med tydlig återkomst. Ett behov av paus ger inte rätt att göra den andra osäker på om kontakt alls kommer att återupptas.</p>
