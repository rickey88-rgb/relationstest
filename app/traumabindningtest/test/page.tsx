...
const CHECKOUT_URL: string = "https://buy.stripe.com/28EbJ02CB4w9dcP3EA0gw0j";
...
export default function Page() {
  ...
  const tracking = useTestAnalytics("trauma_bond_test", questions.length);
        ...
        >
          ...
          >
            ...
            >
              ...
              ✓ hur närhet, otrygghet och relationens växlingar hänger ihop
            </p>
